...
<section class="head success-head">
  <article class="success-article">
    <mat-icon class="success-icon">warning</mat-icon>
    <h2 class="success-message">Welcome back!</h2>
    <p class="success-paragraph">Your details already exist. We're excited to have you join back our community.</p>
  </article>
</section>
...
.success-icon {
  font-size: 10em; /* Increased icon size */
  color:rgb(163, 175, 76);
  display: block;
  margin: 0 auto 20px;
  height: auto;
  width: auto;
